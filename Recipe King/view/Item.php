...
<div class="cat-name">
	...
	<h1 class="cat-type"><center> XXRecipe NameXX </center></h1>

</div>

<div class="recipe-contend">

    <h2 class="item-head">&#9673; Ingredients : </h2>
    <img class="recipe-image" src="img/img.jpg">
    <h2 class="item-head2">&#9673; Preparation : </h2>
