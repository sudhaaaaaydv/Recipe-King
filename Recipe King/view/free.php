<!DOCTYPE html>
<html>
	<title>Free | Sri Lankan Easy Cook...
	</title>
...
<!-- LOGIN & REGISTER BUTTON -->
	...
	<div class="nav">
        ...
        <a button class="button" href="free.html" id="active">Free</button></a>
...
<!-- RECIPES ROW 1 .-->
    ...
    <div class="recipes-row1" >
        <div class="recipe1">
            <a href="item.html"><img class="recipe-image" src="img/img.jpg">
            <center><p class="name">XXRecipe NameXX</p></center></a>
        </div>
