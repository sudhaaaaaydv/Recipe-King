<!DOCTYPE html>
<html>
	<title>Recipes | Seasonal | Sri Lankan Easy Cook...
	</title>
...
<div class="side-bar">
    ...
    <a button class="drop_bt" id="drop_bt2" id="active" href="Seasonal.html">&#9673; Seasonal </button></a>
...
<div class="cat-name">
	...
	<h1 class="cat-type"><center> Seasonal  </center></h1>
