<!DOCTYPE html>
<html>
	<title>Recipes| Meal Type | Sri Lankan Easy Cook...
	</title>
...
<div class="side-bar">
    ...
    <a button class="drop_bt" id="drop_bt1" id="side-active" href="Meal Type.html">&#9673; Meal Type</button></a>
...
<div class="cat-name">
	...
	<h1 class="cat-type"><center> Meal Types </center></h1>
