<!DOCTYPE html>
<html>
	<title>Recipes | Diet & Health | Sri Lankan Easy Cook...
	</title>
...
<head>
	...
	<link rel="stylesheet" href="stylesheets/Cat-Type.css">
...
<!-- SEARCH BAR -->
		   ...
		   <div id="search-bar">
            		<form>
               			...
               			<button class="seach-button" type="submit">Search</button>
            		</form>
...
<div class="side-bar">
    ...
    <a button class="drop_bt" id="drop_bt3" id="active" href="Diet & Health.html">&#9673; Diet & Health</button></a>
...
<div class="cat-name">
	...
	<h1 class="cat-type"><center> Diet & Health </center></h1>
...
<div class="recipes-row1" >
		<div class="recipe1">
			<a href="buyItem.html"><img class="recipe-image" src="img/img.jpg">
			<center><p class="nameNprice">XXRecipe NameXX</p>
			<p class="nameNprice">$$Price$$</p></center></a><img class="cart_image" onclick="myCartFunction()" src="img/Cart.png">
		</div>
