<!DOCTYPE html>
<html>
	<title>Recipes | Dish Type | Sri Lankan Easy Cook...
	</title>
...
<div class="side-bar">
    ...
    <a button class="drop_bt" id="drop_bt4" id="active" href="Dish Type.html">&#9673; Dish Type</button></a>
...
<div class="cat-name">
	...
	<h1 class="cat-type"><center> Dish Types </center></h1>
